    ...
    return (
        <div>
            ...
            <div className="navigation-panel" id="navPanel">
                ...
                <a href="https://rvtk.bkogov.kz/ru/about-us" className="nav-link">О колледже</a>
                <a href="https://rvtk.bkogov.kz/ru/studentterdi-qabyldau-erezeleri" className="nav-link">Как поступить</a>
                <a href="https://rvtk.bkogov.kz/ru/otinis-berusiler-usin-aqparat" className="nav-link">Абитуриенту</a>
            </div>
        </div>
    );
}
